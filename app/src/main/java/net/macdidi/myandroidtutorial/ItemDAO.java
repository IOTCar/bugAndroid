...
public class ItemDAO {
    ...
    // 建立範例資料
    public void sample() {
        Item item = new Item(0, new Date().getTime(), Colors.RED, "測試資料一", "測試資料一內容", "", "", 0, 0, 0);
        Item item2 = new Item(0, new Date().getTime(), Colors.BLUE, "測試資料二", "測試資料二內容", "", "", 25.04719, 121.516981, 0);
        Item item3 = new Item(0, new Date().getTime(), Colors.GREEN, "測試資料三", "測試資料三內容", "", "", 0, 0, 0);
        Item item4 = new Item(0, new Date().getTime(), Colors.ORANGE, "測試資料四", "測試資料四內容", "", "", 0, 0, 0);
