...
public class ItemActivity extends Activity {
   ...
   // private static final int START_CAMERA = 0;
    ...
    private static final int START_VIDEO = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // processViews();
        ...
        //！！有問提記得修！！
        //顯示影片
        VideoView videoView = (VideoView)findViewById(R.id.vidoeView);
        String src = "";//影片路徑
    ...
    public void clickFunction(View view) {
        ...
        switch (id) {
            ...
            case R.id.take_picture:
                ...
                // 影片檔案名稱
                File videoFile = configFileName("v",".mp4");
                Uri uri = Uri.fromFile(videoFile);
                // 設定檔案名稱
                intentVideo.putExtra(MediaStore.EXTRA_OUTPUT, uri);
                // 啟動相機元件
                startActivityForResult(intentVideo, START_VIDEO);
                break;
